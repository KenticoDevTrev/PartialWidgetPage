## Installation Xperience By Kentico [.Net Core] 27.0.0
1. Install the [PartialWidgetPage.Xperience.Mvc.Core](https://www.nuget.org/packages/PartialWidgetPage.Xperience.Mvc.Core/) Nuget Package on your .net Core site.
...
3. Add this TagHelper to your View or _ViewImport.cshtml: `@addTagHelper *, PartialWidgetPage.Xperience.Mvc.Core`
...
1. Install the [`PartialWidgetPage.Xperience.Mvc.Core.Widget] Nuget Package on your .net Core Site.`
...
# Compatability
27.0.0 Can be used on any Xperience By Kentico MVC site .Net Core.  Version 27.0.0 is compatible MVC (.net > 6.0).